...
const SUPABASE_URL = window.TASK_TRACKER_SUPABASE_URL || "https://YOUR_PROJECT.supabase.co";
const SUPABASE_ANON_KEY = window.TASK_TRACKER_SUPABASE_ANON_KEY || "YOUR_SUPABASE_ANON_KEY";
